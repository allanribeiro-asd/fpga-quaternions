...
alias com {
  ...
  vcom "$QSYS_SIMDIR/system_0_quat_0_avalon_slave_0_translator.vhd"                                                       
  ...
  vcom "$QSYS_SIMDIR/system_0_sram_0_avalon_slave_0_translator.vhd"                                                       
}
...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L SD_CLK -L SD_DAT -L switch_pio -L button_pio -L led_green -L led_red -L lcd_16207_0 -L timer_0 -L uart_0 -L jtag_uart_0 -L epcs_controller -L sdram_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L SD_CLK -L SD_DAT -L switch_pio -L button_pio -L led_green -L led_red -L lcd_16207_0 -L timer_0 -L uart_0 -L jtag_uart_0 -L epcs_controller -L sdram_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
